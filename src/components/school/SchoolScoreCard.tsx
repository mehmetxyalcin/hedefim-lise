          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200">
                ...
                <th className="px-1 py-2 text-right text-xs font-medium text-gray-500">OBP</th>
                <th className="px-1 py-2 text-right text-xs font-medium text-gray-500">LGS</th>
                ...
                <tr key={score.id} className="border-b border-gray-100 hover:bg-gray-50">
                  <td className="px-1 py-2.5 text-gray-700">
                    {score.vocational_field?.name ?? (
                      <span className="italic text-gray-400">Okul Geneli</span>
                    )}
                  </td>
