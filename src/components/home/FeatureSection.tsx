...
export function FeatureSection(_props: FeatureSectionProps) {
  return (
      ...
      <div className="container mx-auto max-w-6xl px-6">
        ...
        <div className="grid gap-5 md:grid-cols-3 md:grid-rows-2">
          ...
          >
            ...
            <div className="mt-10 flex items-center gap-1.5 font-display text-sm font-bold tracking-wide text-[var(--teal)] transition-all group-hover:gap-2.5">
              {primary.cta}
