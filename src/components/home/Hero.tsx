...
export function Hero({
  ...
  return (
    <section className="relative">
      <div className="container mx-auto max-w-6xl px-6 pt-12 pb-14 md:pt-16 md:pb-16">
        ...
        <p className="mt-5 max-w-2xl text-lg leading-relaxed text-[var(--ink-soft)] md:text-xl">
