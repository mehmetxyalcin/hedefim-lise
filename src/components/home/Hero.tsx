    ...
    <section className="relative">
      ...
      <div className="container mx-auto max-w-6xl px-6 pt-14 pb-16 md:pt-20 md:pb-20">
        ...
        <p className="mt-6 max-w-2xl text-lg leading-relaxed text-[var(--ink-soft)] md:text-xl">
          MEB ve okul kaynaklarından derlenen yerleştirme verileriyle: elindeki
          sayı yüzdelik dilimi de olsa OBP puanı da olsa aralığını seç, ilçe ve
          okul türüyle daralt, listene başla.
        </p>
